"""
this is the last saved before adding the multi select routes functionality, so here that tranformation and all commented out code is not 
included in the new eda
